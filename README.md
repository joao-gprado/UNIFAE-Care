...
📦 UNIFAE-Care
 ...
 ┣ 📜 .env                 # Variáveis de ambiente secretas (ex: URL da API)
...
3. **Configure as Variáveis de Ambiente:**
   O projeto requer um arquivo `.env` na raiz contendo a URL base da API. Certifique-se de que o arquivo exista com o seguinte formato:
   ```env
   EXPO_PUBLIC_API_URL=http://<IP_DA_SUA_API>:<PORTA>
   ```
...
- **Segurança de Dados:** Uso de variáveis de ambiente (`.env`) para ocultar endereços IPs de servidores, impedindo vazamentos no repositório.
